const en = {
  ...
  career: {
    ...
    applicationForm: {
      ...
      position: 'Position',
      cv: 'CV / Resume (PDF)',
      cvPlaceholder: 'Upload your CV in PDF format',
      cvRequired: 'CV is required',
      cvInvalid: 'Please upload a valid PDF file',
      cvSize: 'File size must be less than 5MB',
      applyingFor: 'I am applying for the position of',
      message: 'Cover Letter / Additional Information',
  ...
  contact: {
    ...
    location: {
      ...
      mapNote: 'Integration with Google Maps, MapBox, or similar service'
    },
    immediateAssistance: {
